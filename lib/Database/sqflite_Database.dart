...
class MyDatabase {
  static MyDatabase _myDatabase = MyDatabase();
  String table_Userdata = 'tbl_userData';
  String column_name = 'name';
  String column_email = 'email';
  String column_password = 'password';

  //Initialize/Creating/Getting Database in the default location ===============
  ...
  void create_Database(Database db, int version) async {
    var sql =
        'CREATE TABLE $table_Userdata($column_name Text,$column_email Text,$column_password Text)';
    db.execute(sql);
  }
